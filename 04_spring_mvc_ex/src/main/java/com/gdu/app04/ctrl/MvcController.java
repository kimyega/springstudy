...
public class MvcController {
  ...
  // DisptcherServlet(servlet-context.xml)에서 ViewResolver를 제거했으므로 JSP의 전체 경로를 지정한다.
  ...
  //@RequestMapping(value = "/register.do", method = RequestMethod.POST)
  public String register2(int articleNo, String title, String content, Model model) {
