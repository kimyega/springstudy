...
@WebAppConfiguration    // controller에서 bean 사용 가능
// log
@Slf4j
public class ContectControllerTest {
  ...
  public void test01_삽입() throws Exception {
    log.info(mockMvc
                .perform(MockMvcRequestBuilders           // 요청 수행
                    ...
                    .param("name", "헤르미온느")          // 요청 파라미터
                    .param("tel", "02-8884-4448")
                    .param("email", "harm@hogwart.com")
                    .param("address", "호그와트"))
                .andReturn()                              // 요청 결과
  ...
  @Test
  public void test03_수정() throws Exception {
    log.info(null);
  }
