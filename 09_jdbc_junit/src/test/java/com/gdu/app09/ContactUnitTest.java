...
public class ContactUnitTest {
   ...
   *    3) @Component   : @ContextConfiguration(locations = "src/main/webapp/WEB-INF/spring/appServlet/root-context.xml")       
   */
  @Autowired
  ...
  public void test03_삭제테스트() {
    ...
    // assertNotNull(contactDao.selectContactByNo(contact_no));  select 결과가 null이면 테스트 성공
  }
}
