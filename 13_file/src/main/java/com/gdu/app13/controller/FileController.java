...
public class FileController {
  ...
  public String upload(MultipartHttpServletRequest mRequest, RedirectAttributes redirectAttributes) {
    int addResult = fileService.upload(mRequest);
  ...
  public Map<String, Object> ajaxUpload(MultipartHttpServletRequest mRequest) {
    return fileService.ajaxUpload(mRequest);
  }
